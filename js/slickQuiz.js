    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                nextQuestionText: 'Selanjtunya &raquo;',
                backButtonText: '&laquo; Sebelumnya',
                completeQuizText: 'Selesai &raquo;',
                tryAgainText: 'Coba lagi?',
                questionCountText: 'Pertanyaan %current dari %total',
                preventUnansweredText: 'Saudara harus memilih satu jawaban.',
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<p class="soal">' + formatQuestion + '</p>');
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var optionLabel = '<label class="" for="' + optionId + '">' + answer.option + '</label>';
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            questionHTML.append('<a href="#" class="button sebelum ' + backToQuestionClass + '">' + plugin.config.backButtonText + '</a>');
                        }
